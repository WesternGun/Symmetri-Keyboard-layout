...
Dead key combinations for circumflex, grave accent and acute accent letters are not implemented, for 2 reasons:
 ...
 - macOS ISO keyboard already has Option + E/U/I + letters, as shown in [this screenshot of Keyboard Viewer](/mac/keyboard-viewer-dead-key.png). With Symmetri rule turned on, they are still available.
